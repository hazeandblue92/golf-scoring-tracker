-- Migration 17: Phase 3 hole-level team aggregate projection/finalization.
-- Aggregate competitions consume individual member scores exactly like
-- generalized best-k; bestK = teamSize is the explicit all-scores-count rule.
