...
| AC-006 | Partial | The production-PWA browser journey caches an event, queues a score offline, reloads from IndexedDB, reconnects, and proves the original idempotency key syncs exactly once. Screen-lock survival and a real Safari/iPhone offline deep-link reload remain device drills. |
